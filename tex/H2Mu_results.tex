...
\begin{figure*}[!htb]
    ...
    \caption{Plot taken from Ref.~\cite{cmscollaboration2020evidence}. 
    Expected fraction of signal events per production mode in the different sub-categories for \mh = 125.38~\GeV.
...
\begin{figure*}[!htb]
    ...
    \caption{Plot taken from Ref.~\cite{cmscollaboration2020evidence}. 
             Expected $S/(S+B)$ and $S/\sqrt{B}$ in different sub-categories, 
...
\begin{figure*}[!htb]
    ...
    \caption{Plot taken from Ref.~\cite{cmscollaboration2020evidence}. 
             Signal strength modifiers measured for \mh = 125.38~\GeV in each production category (black points) 
...
\begin{figure*}[!htb]
    ...
    \caption{Plot taken from Ref.~\cite{cmscollaboration2020evidence}. 
             The local p-values as a function of different \mh hypotheses, 
...
\begin{figure*}[!htb]
    ...
    \caption{Plot taken from Ref.~\cite{cmscollaboration2020evidence}. 
    The observed profile likelihood ratio as a function of $\kappa_{\mu}$ for \mh = 125.38~\GeV.}
...
\begin{figure*}[!htb]
    ...
    \caption{Left: A duplicate of Figure~\ref{fig:higgs_2016}, taken from Ref.~\cite{Sirunyan:2640611}. 
             ...
             Right: The coupling strength measurements updated with this \hmm result. Plot taken from Ref.~\cite{cmscollaboration2020evidence}.}
